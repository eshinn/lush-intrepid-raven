...
local theme = lush(function(injected_functions)
  ...
  return {
    ...
    --
    LspReferenceText            { bg = raven.dark.lens.bg, fg = raven.dark.lens.fg } , -- Used for highlighting "text" references
    ...
    -- WhichKey             {},
    WhichKeyBorder       { bg = raven.dark.panel.bg, fg = raven.dark.panel.bg },
    -- WhichKeyDesc         {},
    -- WhichKeyGroup        {},
    -- WhichKeyIcon         {},
    -- WhichKeyIconAzure    {},
    ...
    -- WhichKeyIconRed      {},
    -- WhichKeyIconYellow   {},
    WhichKeyNormal       { bg = raven.dark.panel.bg },
    -- WhichKeySeparator    {},
    -- WhichKeyTitle        {},
    -- WhichKeyValue        {},
